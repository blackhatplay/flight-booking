          ...
          <div className="services-item">
            ...
            <div className="services-card">
              <ul>
                ...
                <li>
                  <h2>
                    <span>Tuscany to Provence</span>
                    <span>$845</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>Florida Getaway</span>
                    <span>$199</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>NYC Escape</span>
                    <span>$899</span>
                  </h2>
                </li>
              </ul>
          ...
          <div className="services-item">
            ...
            <div className="services-card">
              <ul>
                <li>
                  <h2>
                    <span>Grand Residences Vacation All Inclusive</span>
                    <span>$650</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>Temptation Cancun Resort Package - Adults Only</span>
                    <span>$530</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>Iberostar Selection Cancun All Inclusive</span>
                    <span>$624</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>Wynn Las Vegas Deal</span>
                    <span>$647</span>
                  </h2>
                </li>
                <li>
                  <h2>
                    <span>Caesar's Palace - Resort &amp; Casino</span>
                    <span>$526</span>
                  </h2>
                </li>
              </ul>
